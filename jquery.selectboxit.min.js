...
return this},_createUnorderedList:function(){var a=this,b,d,e,h,g,f,l,n="",m=a.originalElemId||"",m=c("<ul/>",{id:m&&m+"SelectBoxItOptions","class":"selectboxit-options",tabindex:-1}),u,v,t,q,k,r;a.options.showFirstOption||(a.selectItems.first().attr("disabled","disabled"),a.selectItems=a.selectBox.find("option").slice(1));a.selectItems.each(function(m){k=c(this);e=d="";b=k.prop("disabled");h=k.attr("data-icon")||"";f=(g=k.attr("data-iconurl")||"")?"selectboxit-option-icon-url":"";l=g?"style=\"background-image:url('"+
g+"');\"":"";u=k.attr("data-selectedtext");q=(v=k.attr("data-text"))?v:k.text();r=k.parent();r.is("optgroup")&&(d="selectboxit-optgroup-option",0===k.index()&&(e='<span class="selectboxit-optgroup-header '+r.first().attr("class")+'"data-disabled="true">'+r.first().attr("label")+"</span>"));k.attr("value",this.value);n+=e+'<li data-id="'+m+'" data-val="'+this.value+'" data-disabled="'+b+'" class="'+d+" selectboxit-option "+(c(this).attr("class")||"")+'"><a class="selectboxit-option-anchor"><span class="selectboxit-option-icon-container"><i class="selectboxit-option-icon '+
h+" "+(f||a.theme.container)+'"'+l+"></i></span>"+(a.options.html?q:a.htmlEscape(q))+"</a></li>";t=k.attr("data-search");a.textArray[m]=b?"":t?t:q;this.selected&&(a._setText(a.dropdownText,u||q),a.currentFocus=m)});if(a.options.defaultText||a.selectBox.attr("data-text")){var p=a.options.defaultText||a.selectBox.attr("data-text");a._setText(a.dropdownText,p);a.options.defaultText=p}m.append(n);a.list=m;a.dropdownContainer.append(a.list);a.listItems=a.list.children("li");a.listAnchors=a.list.find("a");
...
this.dropdown.attr("tabindex","-1");this.selectBox.css({display:"block",visibility:"visible",width:this._realOuterWidth(this.dropdown),height:this.dropdown.outerHeight(),opacity:"0",position:"absolute",top:"0",left:"0",cursor:"pointer","z-index":"999999",margin:this.dropdown.css("margin"),padding:"0","-webkit-appearance":"menulist-button"});this.originalElem.disabled&&this.triggerEvent("disable");return this};f._mobileEvents=function(){var a=this;a.selectBox.on({"changed.selectBoxIt":function(){a.hasChanged=
!0;a._updateMobileText();a.triggerEvent("option-click")},"mousedown.selectBoxIt":function(){a.hasChanged||!a.options.defaultText||a.originalElem.disabled||(a._updateMobileText(),a.triggerEvent("option-click"))},"enable.selectBoxIt":function(){a.selectBox.removeClass("selectboxit-rendering")},"disable.selectBoxIt":function(){a.selectBox.addClass("selectboxit-rendering")}})};f._mobile=function(a){this.isMobile&&(this._applyNativeSelect(),this._mobileEvents());return this};f.selectOption=function(a,
b){var d=c.type(a);"number"===d?this.selectBox.val(this.selectItems.eq(a).val()).change():"string"===d&&this.selectBox.val(a).change();this._callbackSupport(b);return this};f.setOption=function(a,b,d){var e=this;"string"===c.type(a)&&(e.options[a]=b);e.refresh(function(){e._callbackSupport(d)},!0);return e};f.setOptions=function(a,b){var d=this;c.isPlainObject(a)&&(d.options=c.extend({},d.options,a));d.refresh(function(){d._callbackSupport(b)},!0);return d};f.wait=function(a,b){this.widgetProto._delay.call(this,
b,a);return this};f.add=function(a,b){this._populate(a,function(a){var e=this,h=c.type(a),g=0,f,l=[],n=(f=e._isJSON(a))&&e._parseJSON(a);if(a&&("array"===h||f&&n.data&&"array"===c.type(n.data))||"object"===h&&a.data&&"array"===c.type(a.data)){e._isJSON(a)&&(a=n);a.data&&(a=a.data);for(f=a.length;g<=f-1;g+=1)h=a[g],c.isPlainObject(h)?l.push(c("<option/>",h)):"string"===c.type(h)&&l.push(c("<option/>",{text:h,value:h}));e.selectBox.append(l)}else a&&"string"===h&&!e._isJSON(a)?e.selectBox.append(a):
a&&"object"===h?e.selectBox.append(c("<option/>",a)):a&&e._isJSON(a)&&c.isPlainObject(e._parseJSON(a))&&e.selectBox.append(c("<option/>",e._parseJSON(a)));e.dropdown?e.refresh(function(){e._callbackSupport(b)},!0):e._callbackSupport(b);return e})};f._parseJSON=function(a){return JSON&&JSON.parse&&JSON.parse(a)||c.parseJSON(a)};f._isJSON=function(a){try{return this._parseJSON(a),!0}catch(b){return!1}};f._populate=function(a,b){var d=this;a=c.isFunction(a)?a.call():a;d.isDeferred(a)?a.done(function(a){b.call(d,
a)}):b.call(d,a);return d};f.remove=function(a,b){var d=this,e=c.type(a),h=0,g,f="";if("array"===e){for(g=a.length;h<=g-1;h+=1)e=a[h],"number"===c.type(e)&&(f=f.length?f+(", option:eq("+e+")"):f+("option:eq("+e+")"));d.selectBox.find(f).remove()}else"number"===e?d.selectBox.find("option").eq(a).remove():d.selectBox.find("option").remove();d.dropdown?d.refresh(function(){d._callbackSupport(b)},!0):d._callbackSupport(b);return d}});
